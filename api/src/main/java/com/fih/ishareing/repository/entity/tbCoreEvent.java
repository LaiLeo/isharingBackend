...
/**
 * The persistent class for the core_event database table.
 * 
 */
@Entity
@Table(name = "core_event")
public class tbCoreEvent implements Serializable {
	@Id
	...
	private Boolean isVolunteerEvent;
	...
	public Boolean getVolunteerEvent() {
		return isVolunteerEvent;
	}

	public void setVolunteerEvent(Boolean volunteerEvent) {
		isVolunteerEvent = volunteerEvent;
	}
